      ...
      <div class="header">
        ...
        <form role="form">
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="inputEmail1" placeholder="Enter Your Name">
          </div>
          <div class="form-group">
            <label for="inputradio">Gender</label>
            <input type="radio"id="radio1" name="optionsRadios" >Male
            <input type="radio"id="radio2" name="optionsRadios">Female
          </div>
          <div class="form-group">
